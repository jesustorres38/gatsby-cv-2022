  ...
  return (
    <Layout>
      <div>
        ...
        <p>The tools of my day to day are:</p>
        <ul>
          <li>Atlassian suit (Jira, Confluence, Bitbucket)</li>
          <li>Git</li>
          <li>Zeplin / Sketch</li>
          <li>Javascript (Vanilla, JQuery, React, etc)</li>
          <li>HTML5</li>
          <li>CSS (Bootstrap, SASS and PostCSS Preprocessors)</li>
          <li>Webpack</li>
